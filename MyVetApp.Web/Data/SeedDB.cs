...
namespace MyVetApp.Web.Data{
    public class SeedDB{
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckRoles();
            var manager = await CheckUserAsync("1010", "Luis", "Rodriguez", "dev@gmail.com", "350 634 2747", "Calle Luna Calle Sol", "Admin");
            var customer = await CheckUserAsync("2020", "Luis", "Carrera", "car@hotmail.com", "350 634 2747", "Calle Luna Calle Sol", "Customer");
